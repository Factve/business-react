...
import FoodsUserPage from './pages/FoodsUser/FoodsUserPage';
import FoodEditUserPage from './pages/FoodEditUser/FoodEditUserPage';
...
export default function AppRoutes() {
  return (
      ...
      <Routes>
        ...
        <Route path="/foods/:searchTerm?" element={<AuthRoute><FoodsUserPage /></AuthRoute>} />
        ...
        <Route path="/addFood" element={<AuthRoute><FoodEditUserPage /></AuthRoute>} />
        <Route path="/admin/editFood/:foodId" element={<AdminRoute><FoodEditPage /></AdminRoute>} />
        <Route path="/editFood/:foodId" element={<AuthRoute><FoodEditUserPage /></AuthRoute>} />
